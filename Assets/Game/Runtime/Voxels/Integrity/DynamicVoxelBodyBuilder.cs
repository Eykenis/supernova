            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                    ...
                    seedIndex++)
                {
                    ...
                    float fullVoxelVolume = voxelSize * voxelSize * voxelSize;
                    float representedFullVoxels = fullVoxelVolume > 0f
                        ? properties.Volume / fullVoxelVolume
                        : 0f;
                    float mass = Mathf.Max(
                        0.01f,
                        representedFullVoxels * averageMassPerFullVoxel);
