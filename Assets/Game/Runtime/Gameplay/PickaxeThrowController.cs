...
namespace Supernova.Gameplay
{
    ...
    public sealed class PickaxeThrowController : MonoBehaviour
    {
        ...
        private const float ThrowSoundVolumeScale = 0.5f;
        ...
        private SoundEffectCue activeThrowSound;
        ...
        public ThrownPickaxe ReleaseThrow()
        {
            ...
            pickaxe.Launch(
                ...
                definition.ThrownTerrainHitSound);

            activeThrow = pickaxe;
            activeThrowSound = definition.ThrowSound;
            toolController?.SuspendItem(definition.Item);
            SoundEffectEvents.RequestPlay(
                activeThrowSound,
                origin,
                ThrowSoundVolumeScale);
            return pickaxe;
        }
        ...
        public bool RecallThrow()
        {
            ...
            Vector3 soundPosition = activeThrow.transform.position;
            if (!activeThrow.BeginRecall()) return false;
        ...
        private void Update()
        {
            ...
            else if (!activeThrow.CanBeRecovered)
            {
                activeThrow = null;
                activeThrowSound = null;
            }
