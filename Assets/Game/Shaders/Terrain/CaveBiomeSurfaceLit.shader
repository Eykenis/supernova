Shader "Supernova/Terrain/Grass Turf Layer"
{
    Properties
    {
        ...
        [HideInInspector] _ClearCoatSmoothness(
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Tags
            {
                // ForwardOnly keeps the transparent turf correct in both
                // forward and deferred URP renderers.
            ...
            HLSLPROGRAM
            #pragma target 3.5
            #pragma vertex CaveBiomeSurfaceLitPassVertex
            #pragma fragment CaveBiomeSurfaceLitPassFragment
            ...
            #include_with_pragmas "Packages/com.unity.render-pipelines.universal/ShaderLibrary/APSKeywords.hlsl"
            ...
            #include "Assets/Game/Shaders/Terrain/CaveBiomeSurfaceLitForwardPass.hlsl"
            ENDHLSL
        }
